...
java %OPTIONS% -cp %TOOL_JAR% drdup.Sourcer %SRC_DIR% bigclonebench-consistent-minsize-6-dir.xml

java %OPTIONS% -jar %CHECKER_JAR% checker.properties

echo "All clones"
java %OPTIONS% -cp %TOOL_JAR% drdup.Counter bigclonebench-consistent-minsize-6-dir.xml
echo "Type 1"
